            ...
            <div>
                <Grid container>
                    <Grid
                        direction="column"
                        alignItems="center"
                        justifyContent="center" item lg={6} xs={12}>
                        <Container style={{ margin: "50px", padding: "50px" }} component="main">
                            <CssBaseline />
                            <Card style={{ padding: "30px", width: "80%", borderRadius: "30px", boxShadow: "5px 5px 25px 5px" }}>
                                <Box
                                    sx={{
                                        marginTop: 8,
                                        display: 'flex',
                    ...
                    <Grid item lg={6} xs={12}>
                        ...
                        >
                            <img src={signup1} style={{ width: "80%", marginTop: "50px" }} alt="login1" />
                            {/* </Card> */}
                        </Box>
                    </Grid>
                </Grid>
