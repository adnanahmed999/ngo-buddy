    ...
    <>
      <div style={{ backgroundColor: "#87d5fa", paddingTop: "20px" }}>
        ...
        >
          ...
          <br />
          {value === 1 ? (
            <Card style={{ marginBottom: "30px", borderRadius: "30px", boxShadow: "5px 5px 25px 5px black", width: "60%", paddingLeft: "10px" }}>
              <div style={{ margin: "10px" }}>
                <h2>NGO Buddy</h2>
                <p>Vile Parle, near D. J. Sanghvi of College Engineering, Mumbai - 400093</p>
                <img src="https://images.hindustantimes.com/img/2021/10/30/1600x900/Life_beyond_Numbers_1635579657650_1635579881820.PNG" alt="hospital-img" style={{ width: "200px", borderRadius: "30px" }} />
                <br />
                <a href="https://www.google.com" style={{ textDecoration: "none" }}>
                  <Button style={{ margin: "10px" }} variant="contained" color="primary">View on Map</Button></a>
          ...
          {value === 2 ? (
            <Card style={{ marginBottom: "30px", borderRadius: "30px", boxShadow: "5px 5px 25px 5px black", width: "60%", paddingLeft: "10px" }}>
              <div style={{ margin: "10px" }}>
                ...
                <img src={hospitaljpeg} alt="hospital-img" style={{ width: "200px", borderRadius: "30px" }} />
                <br />
                <Button style={{ margin: "10px" }} variant="contained" color="primary">View on Map</Button>
              </div>
            </Card>
          ) : ""}
          {value === 3 ? (
