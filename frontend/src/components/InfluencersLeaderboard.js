    ...
    return (
        <div style={{ backgroundColor: "#87d5fa", paddingTop: "20px", ppaddingBottom: "50px" }}>
            <div style={{ margin: "100px" }}>
                <h1 style={{ textAlign: "center" }}>Influencers LeaderBoard</h1>
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                <TableCell><h3 style={{ textAlign: "center" }}>Sr. No.</h3></TableCell>
                                <TableCell align="right"><h3 style={{ textAlign: "center" }}>Avatar</h3></TableCell>
                                <TableCell align="right"><h3 style={{ textAlign: "center" }}>Name</h3></TableCell>
                                <TableCell align="right"><h3 style={{ textAlign: "center" }}>Points</h3></TableCell>
                                <TableCell align="right"><h3 style={{ textAlign: "center" }}>Badge</h3></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {rows.map((row) => (
                                <TableRow key={row.srno}>
                                    ...
                                    <TableCell align="right"><Avatar>{row.avatar}</Avatar></TableCell>
                                    <TableCell align="center">{row.name}</TableCell>
                                    <TableCell align="center">{row.points}</TableCell>
                                    <TableCell align="center">
                                        <Button style={{ backgroundColor: `${row.badge}` }}>{row.badge}</Button>
                                    </TableCell>
...
export default InfluencersLeaderboard