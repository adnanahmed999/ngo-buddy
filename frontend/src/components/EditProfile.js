...
function EditProfile({ history }) {
    ...
    //                 fetch(
    //                     `https://localhost:8080/user/userUpdate/${userInfo.data._id}`,
    //                     requestOptions
    //                 )
    //                     .then((response) => {
        ...
        <div style={{ backgroundColor: "#87d5fa" }}>
            <div>
                ...
                <Card className={classes.profileCard}>
                    <Grid container>
                        <h1 style={{ marginLeft: "100px", textAlign: "center" }}>Edit Profile</h1>
                        <Grid item xs={12} sm={12}>
                            <div style={{ marginLeft: "100px" }}><img src={userInfo.data.profilePicture} alt="profilepic" style={{ borderRadius: "100%", width: "100px", display: "flex", alignItems: "center", justifyContent: "center" }} />
                                <Typography>Edit your Profile Picture</Typography>
                                <TextField type="file" name="profilePicture" onChange={uploadNewPic}>Edit Profile Picture</TextField></div>
                                    ...
                                    <TableBody>
                                        <TableRow key="Name">
                                            ...
                                            <TableCell align="right">
                                                <TextField onChange={handleChange} name="name" defaultValue={user.name} />
                                            </TableCell>
                                        </TableRow>
                                        <TableRow key="Email">
                                            <TableCell component="th" scope="row">
                                        ...
                                        <TableRow key="Description">
                                            ...
                                            <TableCell align="right"><TextField onChange={handleChange} name="description" defaultValue={user.description} /></TableCell>
                                        </TableRow>
                                        <TableRow key="Mobile Number">
                                            ...
                                            {user.mobileNumber === "" || null ? (
                                                ...
                                                <TableCell align="right">
                                                    <TextField onChange={handleChange} type="number" name="mobileNumber" defaultValue={user.mobileNumber} />
                                                </TableCell>
                                            )}
                                        </TableRow>
