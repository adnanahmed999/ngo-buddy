    ...
    return (
        <div style={{ backgroundColor: "#87d5fa" }}>
            ...
            <div style={{ paddingTop: "70px", backgroundColor: "#87d5fa" }}>
                <h1 style={{ textAlign: "center", fontSize: "50px", }}>Gift Card</h1>
                <Grid container
                    spacing={0}
                    direction="column"
                    alignItems="center"
                    justifyContent="center">
                    <Card style={{ marginBottom: "100px", borderRadius: "30px", boxShadow: "5px 5px 25px 5px black", width: "70%" }}>
                        <Grid container
                        >
                            <Grid item xs={12} sm={12} md={12} lg={7}>

                                <h2 style={{ marginLeft: "10%" }}>Occasion</h2>
                                <Paper square>
                                    <Tabs
                                        value={value}
                                ...
                                <img style={{ width: "400px" }} src={giftcard} alt="creditcard" />
                            </Grid>
                                ...
                                <Grid container
                                    ...
                                    <Card style={{ position: "relative", right: "40px", borderRadius: "30px", margin: "30px", marginRight: "100px", padding: "30px", boxShadow: "5px 5px 25px 5px black" }}>
                                        ...
                                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                                            ...
                                            <div>
                                                <h3>Amount</h3>
                                                <Input onChange={(e) => { setGiftCardValue(e.target.value) }} style={{ marginRight: "10px" }} defaultValue={`${giftCardValue}`} />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <br /><br />
                                            <Button style={{
                                                marginLeft: "55px", borderRadius: "999px", width: "50%", margin: "5px", backgroundColor: "#03ab14",
