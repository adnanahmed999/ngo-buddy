                ...
                <div className="singleBlog-container">
                    <div className="singleBlog-container__backgroundContainer">
                        ...
                        <div className="singleBlog-container__backgroundContainer-contentContainer">
                            <div>
                                ...
                                <span className='mediaBlog-createdAt' style={{ color: "white" }}>
                    ...
                    <div className="singleBlog-container__contentContainer">
                        <div className="singleBlog-container__contentContainer-contentBx">
                            <div>
                                <h3 className='media-description'>This is the description of the blog.</h3>
                                <span className="media-body">This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. This is the body of the blog. </span>
                                <div className="extra-section">
                                    <div>

                                        <span>{likeBlog === true ? <FavoriteBorderIcon /> : <FavoriteBorderIcon />} { }</span>
                                ...
                                <form>
                                    <div className='addCommentBox' style={{ marginRight: "20px" }}>
                                        <textarea style={{ backgroundColor: "lightgrey" }} placeholder='Add Your Comment...' name='comment' onChange={(e) => { setComment(e.target.value) }} value={comment}></textarea>
                                        <div>
                                            <input type="submit" value={'post'} style={{ backgroundColor: "orange" }} disabled={(comment === "" ? true : false)} />
                                        </div>
                                    </div>
                                </form>
                                <div className="hr"></div>
